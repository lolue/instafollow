C #!/bin/bash
# Inshackle v0.5
# FOLLOW ME ON INSTAGRAM @andrux.__
# SUBSCRIBE DUEL TECHY ALSO

echo ""
xdg-open https://youtube.com/channel/UCJvKZ0lhL8EWvk79wlQkW5A
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by andrux.__ (FOLLOW ME ON INSTAGRAM YOU CAN ANY DOUBTS ALSO)\e[0m\n"
}
